...
import { Home, Info, Calendar, BookOpen, Image, LogOut, User, Navigation, FileText, Heart, Radio } from 'lucide-react';
...
export default function AdminDashboardPage() {
  ...
  const pages = [
    ...
    },
    {
      ...
      icon: Radio,
      description: 'Manage the Zoom link and content for the /service page',
